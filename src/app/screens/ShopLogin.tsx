...
export function ShopLogin() {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center p-6">
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#121212] mb-2">Shop Owner Login</h1>
          <p className="text-gray-600">Manage your shop and view analytics</p>
        </div>
